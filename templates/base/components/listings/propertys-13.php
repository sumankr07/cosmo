...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
    <div class="property-listing list_view border style_new">
                ...
                <div class="footer-first">
                    <div class="listing-features-info">
                        <ul class="featur_5269">
                            <li><div class="ft_th" data-bs-toggle="tooltip" data-bs-placement="top" title="Pet Allowed"><i class="fa-solid fa-dog text-muted-2"></i></div></li>
                            <li><div class="ft_th" data-bs-toggle="tooltip" data-bs-placement="top" title="Air Conditions"><i class="fa-solid fa-snowflake text-muted-2"></i></div></li>
                            <li><div class="ft_th" data-bs-toggle="tooltip" data-bs-placement="top" title="Wifi Avaialable"><i class="fa-solid fa-wifi text-muted-2"></i></div></li>
                            <li><div class="ft_th" data-bs-toggle="tooltip" data-bs-placement="top" title="Gym Center"><i class="fa-solid fa-dumbbell text-muted-2"></i></div></li>
                            <li><div class="ft_th" data-bs-toggle="tooltip" data-bs-placement="top" title="Car Parking"><i class="fa-solid fa-car text-muted-2"></i></div></li>
                        </ul>
                    </div>
                </div>
